...
const rowOne = [
  { Icon: IconHome,  to: 8000,  from: 0, prefix: "", suffix: "+", format: true,  label: "Lahore Plots Delivered" },
  { Icon: IconPin,   to: 500,   from: 0, prefix: "", suffix: "+", format: true,  label: "Lahore Commercial Units" },
  { Icon: IconTrend, to: 250,   from: 0, prefix: "", suffix: "+", format: false, label: "Happy Families" },
];
const rowTwo = [
  { Icon: IconHome,  to: 10000, from: 0, prefix: "", suffix: "+", format: true,  label: "Future Residential Projects" },
  { Icon: IconPin,   to: 100,   from: 0, prefix: "", suffix: "+", format: false, label: "Future Commercial Projects" },
  { Icon: IconTrend, to: 15000, from: 0, prefix: "", suffix: "+", format: true,  label: "Prospective Residents" },
];
...
export default function LahoreStatsSection() {
      ...
      <div className="relative mx-auto max-w-[1000px] px-6 sm:px-10 flex flex-col items-center">
        ...
        <motion.div
          ...
          <h2 className="relative z-10 text-center font-termina uppercase leading-[1.2] tracking-[0.14em] text-[24px] sm:text-[32px] lg:text-[40px]"
            ...
            The Premier Luxury<br />Developer in Lahore
          </h2>
        </motion.div>
        ...
        <motion.p
          ...
          Parkview City Lahore at a Glance
        </motion.p>
