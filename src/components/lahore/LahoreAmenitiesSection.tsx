...
export default function LahoreAmenitiesSection() {
  return (
      ...
      <div className="mx-auto max-w-[1400px] px-6 sm:px-10">
        ...
        <motion.div
          ...
          <p className="mt-5 w-full max-w-[1247px] mx-auto font-roboto text-[16px] font-light leading-[24px] tracking-[0.9px] text-center text-pvc-grey">
            From grand promenades to botanical gardens, Parkview City Lahore offers world-class amenities within its beautifully planned community.
          </p>
        </motion.div>
