...
export default function LahoreCuratedSection() {
  ...
  return (
    ...
    <section className="relative bg-white pt-16 sm:pt-32 pb-[150px] sm:pb-[500px] -mb-[60px] sm:-mb-[660px] overflow-hidden">
      ...
      >
        ...
        >
          Parkview City Lahore is more than a real estate development. It is a growing
          vision for secure, scenic, and modern urban living in the heart of Lahore. Whether you are
          looking for a home, a commercial opportunity, or a long-term
          investment, ParkView City Lahore offers a destination built for today and
          tomorrow.
        </p>
