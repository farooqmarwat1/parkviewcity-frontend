...
export default function IslamabadVirtualTourSection() {
  return (
    <section
      id="virtual-tour"
    ...
    >
      <img
        src="/lastsection-isb.png"
        alt="ParkView City Islamabad drone view"
      ...
      >
        ...
        <h2 className="mt-3 font-termina text-[28px] font-normal uppercase leading-tight tracking-[0.06em] text-white sm:text-[36px]">
          Islamabad Virtual Tour
        </h2>

        <a
          href="https://pvvtour.com/isl/index.html"
          target="_blank"
